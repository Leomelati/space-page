            ...
            <div className='d-flex flex-row'>
              <button onClick={() => setDestination('moon')} type="button"
                className={`btn text-secondary btn-destinations heading-3
                  ${(destination === 'moon') ? 'btn-destinations-active' : ''}`}>
                MOON
              </button>
              <button onClick={() => setDestination('mars')} type="button"
                className={`btn text-secondary btn-destinations heading-3
                  ${(destination === 'mars') ? 'btn-destinations-active' : ''} `}>
                MARS
              </button>
              <button onClick={() => setDestination('europa')} type="button"
                className={`btn text-secondary btn-destinations heading-3
                  ${(destination === 'europa') ? 'btn-destinations-active' : ''} `}>
                EUROPA
              </button>
              <button onClick={() => setDestination('titan')} type="button"
                className={`btn text-secondary btn-destinations heading-3
                  ${(destination === 'titan') ? 'btn-destinations-active' : ''} `}>
                TITAN
              </button>
            </div>
